...
<body>
    ...
    <div>
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CssClass="auto-style1" DataKeyNames="recipeID" DataSourceID="SqlDataSource_HW6_detail_view" Height="50px" Width="311px">
            <Fields>
